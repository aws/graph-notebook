...
- New Northwind Use Case notebook ([Link to PR](https://github.com/aws/graph-notebook/pull/572))
  - Path: 01-Neptune-Database > 03-Sample-Applications > 07-Northwind-Use-Case
