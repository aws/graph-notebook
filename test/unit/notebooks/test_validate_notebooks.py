...
class TestValidateAllNotebooks(unittest.TestCase):
    ...
    def test_no_extra_notebooks(self):
        ...
        expected_paths = [
            ...
            f'{NOTEBOOK_BASE_DIR}/Introduction-to-Identity-Graphs.ipynb',
            f'{NOTEBOOK_BASE_DIR}/Introduction-to-Knowledge-Graphs.ipynb',
            f'{NOTEBOOK_BASE_DIR}/Introduction-to-Fraud-Graphs.ipynb',
