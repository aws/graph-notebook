...
def do_opencypher_status(host, port, use_ssl, mode, request_param_generator, query_id=''):
    data = {}
    if query_id is not '':
...
def do_opencypher_cancel(host, port, use_ssl, mode, request_param_generator, query_id='', silent=False):
