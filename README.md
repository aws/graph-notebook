...
`%seed` - Provides a form to add data to your graph without the use of a bulk loader. Sample RDF and Property Graph data models are provided with this command. Alternatively, you can select a language type and provide the full path of a file directory to load from.
