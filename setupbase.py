...
venv_packages = site.getsitepackages()[0]
HERE = os.path.abspath(os.path.dirname(__file__))
is_repo = os.path.exists(pjoin(HERE, '.git'))
widgets_root = pjoin(HERE, 'src', 'graph_notebook', 'widgets')
node_modules = pjoin(widgets_root, 'node_modules')
...
def install_npm(path=None, build_dir=None, source_dir=None, build_cmd='build', force=True, npm=None):
